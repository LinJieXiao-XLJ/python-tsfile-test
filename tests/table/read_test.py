...
#
# path = "C:\\IoTDBProjects\\iotdb-all\\timechodb-2.0.3-SNAPSHOT-bin-all\\timechodb-2.0.3.1-bin-rc3\\data\\datanode\\data\\sequence\\test\\18\\0\\1746522795990-1-0-0.tsfile"
#
# table_data_dir = os.path.join(path)
#
# table_name = "t1"
